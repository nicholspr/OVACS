    ...
    <section class="hero" style="padding: 6rem 0 3rem;">
        <div class="container">
            ...
            <div style="background: #f8f9fa; padding: 20px; border-radius: 10px; margin-top: 2rem;">
                <form method="GET" action="vehicles.php" style="display: flex; gap: 15px; flex-wrap: wrap; align-items: end;">
                    <div>
                        <label style="display: block; margin-bottom: 5px; font-weight: 600;">Vehicle Type:</label>
                        <select name="type" style="padding: 8px 12px; border: 1px solid #ced4da; border-radius: 5px; background: white; min-width: 180px;">
                    ...
                    <div>
                        ...
                        <select name="station" style="padding: 8px 12px; border: 1px solid #ced4da; border-radius: 5px; background: white; min-width: 200px;">
                    ...
                    <div>
                        ...
                        <select name="status" style="padding: 8px 12px; border: 1px solid #ced4da; border-radius: 5px; background: white; min-width: 150px;">
                    ...
                    <div>
                        <button type="submit" style="padding: 8px 16px; background: #0066cc; color: white; border: none; border-radius: 5px; cursor: pointer; font-weight: 600;">🔍 Apply Filters</button>
